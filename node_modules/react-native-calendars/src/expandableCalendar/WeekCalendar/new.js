...
const WeekCalendar = (props) => {
    ...
    return (<View testID={testID} style={[allowShadow && style.current.containerShadow, !hideDayNames && style.current.containerWrapper]}>
      ...
      <View>
        <InfiniteList key="week-list" ref={list} data={items} renderItem={renderItem} extendedState={extraData} style={style.current.container} initialPageIndex={NUMBER_OF_PAGES} pageHeight={48} pageWidth={containerWidth} onPageChange={onPageChange} onReachEdge={onReachEdge} scrollViewProps={{
