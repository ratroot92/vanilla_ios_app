...
import styleConstructor from 'react-native-calendars/src/dayAgenda/reservation-list/style';
import Reservation from 'react-native-calendars/src/dayAgenda/reservation-list/reservation';
...
class ReservationList extends Component {
  ...
  renderRow = ({item, index}) => {
    ...
    return (
      ...
      //   {this.props.items[item.date.toISOString().split('T')[0]].hours.map(
      //     el => (
      //       <Reservation
      //         {...reservationProps}
      //         key={index}
