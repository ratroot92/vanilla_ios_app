...
class ReservationList extends Component {
    ...
    renderRow = ({ item, index }) => {
        const key = this.props.selectedDay.toISOString().split('T')[0];
        const currentItem = this.props.items[key];
        ...
        return (<View onLayout={this.onRowLayoutChange.bind(this, index)}>
            <Reservation currentItem={currentItem} content={this.props.renderItem} {...reservationProps} item={item.reservation} date={item.date} />
        </View>);
