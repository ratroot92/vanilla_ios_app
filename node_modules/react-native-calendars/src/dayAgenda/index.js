...
import {parseDate, xdateToData, toMarkingFormat} from 'react-native-calendars/src/interface';
import {weekDayNames, sameDate, sameMonth} from 'react-native-calendars/src/dateutils';
// @ts-expect-error
import {AGENDA_CALENDAR_KNOB} from 'react-native-calendars/src/testIDs';
import {VelocityTracker} from 'react-native-calendars/src/velocityTracker';
import {getCalendarDateString} from 'react-native-calendars/src/services';
import styleConstructor from 'react-native-calendars/src/dayAgenda/style';
import CalendarList from 'react-native-calendars/src/calendar-list';
import ReservationList from 'react-native-calendars/src/dayAgenda/reservation-list';
...
export default class Agenda extends Component {
  ...
  renderReservations() {
   ...
   const current=this.props.items[this.props.selected].hours;
